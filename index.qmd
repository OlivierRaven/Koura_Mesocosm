...
if (file.exists(.i)) cat(sprintf('<div class="ch-hero-wrap"><img class="ch-hero-img" src="%s" alt=""><div class="ch-hero-fade"></div><div class="ch-hero-text"><span class="ch-eyebrow">Chapter 4</span><p class="ch-hero-title">The Importance of Structure</p></div></div>', knitr::image_uri(.i)))
```
