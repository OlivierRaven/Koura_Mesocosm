...
chapter_dir <- if (basename(normalizePath(getwd())) == "04_koura_mesocosm") normalizePath(getwd()) else normalizePath(file.path(getwd(), "04_koura_mesocosm"))
