...
ce2_pp <- ce2_p + labs(x = NULL, y = NULL, title = "Exp 2: Group kōura", tag = NULL)
ce3_pp <- ce3_p + labs(x = NULL, y = "Predicted probability (95% CI)", title = "Exp 3: Wood vs Stone", tag = NULL)
ce4_pp <- ce4_p + labs(x = NULL, y = NULL, title = "Exp 4: Bricks", tag = NULL)

ce_all <- ce2_pp + ce3_pp + ce4_pp + plot_layout(nrow = 2)

ggsave(ce_all, file = file.path(out_dir, "fig-ce-all-presentation.png"), width = 6.5, height = 6.5, dpi = 300)
